...
const FrontPagePart = () => {
  return (
    <>
      <img className="frontpageimage" src="https://media-exp1.licdn.com/dms/image/C4E03AQGv1qk-N_gASQ/profile-displayphoto-shrink_200_200/0/1622059523351?e=1630540800&v=beta&t=WxtIzTxYJEaanZwMUhAlzMyfK-as-FtSUXFqLMXysoQ" alt="mypicture"/>
